...
import readmoreblogcontenttwo from "../data/readmoreblog.json";
import Footer from "../components/Footer";


const IndividualBlogPageTwo = () => {
    return (
      <>
        <NavbarSection />
        <ReadMoreBlogSection />
      ...
      <div className="container-fluid">
        {/* <div className="container "> */}
          <div className="row justify-content-center ">
            ...
            {readmoreblogcontenttwo.readmoreblogcontenttwo.map((readmoreblog) => {
              return (
...
export default IndividualBlogPageTwo;